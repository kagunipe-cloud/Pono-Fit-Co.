...
type OccurrenceBooking = { class_name?: string; occurrence_date?: string; occurrence_time?: string };
              ...
              <ul className="space-y-4">
                {occurrenceBookings.map((b, i) => (
                  <li key={i} className="p-4 rounded-xl border border-stone-200 bg-white">
                    ...
                    <p className="text-sm text-stone-500">{b.occurrence_date} at {b.occurrence_time}</p>
                  </li>
                ))}
              </ul>
            </section>
